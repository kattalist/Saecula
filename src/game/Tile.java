...
public class Tile {
    ...
    /*
     COLONY STATS:
     Level 1: +2 population/min, +3 gold/min, -2 food/min, -5 power/min
     Level 2: +4 population/min, +5 gold/min, -5 food/min, -10 power/min(5c + 5sb cost)
     Level 3: +10 population/min, +15 gold/min, -10 food/min, -15 power/min(15c + 20sb cost)
     Level 4: +25 population/min, +40 gold/min, -20 food/min, -25 power/min(30c + 40sb cost)
     Level 5: +60 population/min, +100 gold/min, -50 food/min, 50 power/min(75c + 100sb cost)
     SPECIAL USES:
        ...
        if (usage == 0) {
            ...
            switch (colonyLevel) {
                case 1:
                    ...
                    g.drawString("+4 population/min, +5 gold/min, -5 food/min, -10 power/min", 250, 271);
                    break;
                case 2:
                    g.drawString("Upgrade to a Level 3 colony (-15 credits, -20 stone/brick)", 250, 245);
                    g.drawString("+10 population/min, +15 gold/min, -10 food/min, -15 power/min", 250, 271);
                    break;
                case 3:
                    g.drawString("Upgrade to a Level 4 colony (-30 credits, -40 stone/brick)", 250, 245);
                    g.drawString("+25 population/min, +40 gold/min, -20 food/min, -25 power/min", 250, 271);
                    break;
                case 4:
                    g.drawString("Upgrade to a Level 5 colony (-75 credits, -100 stone/brick)", 250, 245);
                    g.drawString("+60 population/min, +100 gold/min, -50 food/min, -50 power/min", 250, 271);
                    break;
                default: 
                    g.setFont(g.getFont().deriveFont(16.0f));
